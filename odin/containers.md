...
configuration**. The only YAML files tracked are `.github/workflows/tests.yml` (CI) and
`.pre-commit-config.yaml`; the only "registry" references in code are in-process Python
