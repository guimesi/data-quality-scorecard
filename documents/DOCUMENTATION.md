...
| 6 | [ui/step_06_dashboard.py](../ui/step_06_dashboard.py) | Scorecard dashboard (standard + custom subscores, custom rules tab) + CSV / JSON export. Nav row exposes a **🧪 ML Lab (beta)** button that opens Step 7. |
